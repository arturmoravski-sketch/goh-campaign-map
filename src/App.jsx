...
const campaignPhases = [
  ...
  },
  {
    ...
    mapUrl: "/maps/eastern-front-caucasus-1942-43.jpg",
    badge: "заготовка",
    description: "Южный театр: Ростов, Кубань, Кавказ и Сталинград. Карта подключена как основа, позже подгоним отдельные точки и события.",
    rules: [
...
const campaignEvents = [
  ...
  },
  {
    ...
    subtitle: "гарнизон без отхода",
    x: 30,
    y: 55,
    turns: [1],
    provinceIds: ["brest"],
    description: "На рассвете 22 июня крепость принимает первый удар. Даже без полевой армии оборона считается особым гарнизоном.",
    battleRule: "Сценарный бой: СССР играет гарнизон Бреста на усиленную оборону. Отступления нет; при поражении провинция переходит Германии, но советская армия силы не теряет, если ее нет в бою.",
    attackerHint: "Хорошо подходит для короткого штурма с ограниченной бронетехникой и сильной пехотой.",
  },
  {
    id: "bialystok_minsk_pocket",
    phaseId: "barbarossa_1941",
    title: "Белосток-Минск",
    subtitle: "угроза окружения",
    x: 37,
    y: 48,
    turns: [1, 2],
    provinceIds: ["bialystok", "vilnius", "minsk", "mogilev"],
    description: "Западный фронт рискует попасть в котел, если немецкие группы быстро сходятся к Минску.",
    battleRule: "Если Германия побеждает в одной из провинций зоны и отмечено окружение, советская группа получает +1 потерю силы. СССР может выбрать оборонительный бой с гарнизоном, чтобы выиграть время.",
    attackerHint: "Для Германии это главный темповый рывок первой фазы; для СССР - бой на задержку и спасение армии.",
  },
  {
    id: "daugavpils_riga_crossings",
    phaseId: "barbarossa_1941",
    title: "Двинск-Рига",
    subtitle: "переправы",
    x: 38,
    y: 34,
    turns: [1, 2],
    provinceIds: ["riga", "daugavpils", "pskov"],
    description: "Северное направление держится на переправах через Западную Двину и дороге к Пскову.",
    battleRule: "Сценарный бой за мосты: победитель может считать соседнюю переправу разведанной. Германия получает право на блицкриг-шаг только если бой выигран с легкими или средними потерями.",
    attackerHint: "Здесь хорошо работают быстрые отряды, разведка, бронеавтомобили и легкая артиллерия.",
  },
  {
    id: "kyiv_pocket_warning",
    phaseId: "barbarossa_1941",
    title: "Киевская дуга",
    subtitle: "опасность котла",
    x: 55,
    y: 63,
    turns: [3, 4, 5],
    provinceIds: ["kyiv", "zhytomyr", "chernihiv", "cherkasy", "uman"],
    description: "Юго-Западный фронт удерживает Киев, но глубокие немецкие прорывы могут превратить оборону в окружение.",
    battleRule: "Если Германия контролирует две соседние провинции зоны и выигрывает бой, можно отметить окружение. СССР получает право на один оборонительный гарнизон 5000 ЛС в Киеве или Чернигове.",
    attackerHint: "Это событие лучше включать после первых немецких успехов на юге.",
  },
  {
    id: "odessa_defense",
    phaseId: "barbarossa_1941",
    title: "Одесская оборона",
    subtitle: "портовая осада",
    x: 55,
    y: 84,
    turns: [4, 5],
    provinceIds: ["odessa", "mykolaiv", "uman"],
    description: "Одесса может стать отдельной осадной точкой на юге, даже если основные армии уже ушли восточнее.",
    battleRule: "Гарнизон Одессы играет минимум 3500 ЛС, при договоренности 5000 ЛС. Германия не получает блицкриг-шаг после победы в портовой осаде.",
    attackerHint: "Хорошо подходит для пехотного штурма с минометами, ПТО и ограниченной броней.",
  },
];
